 ...
 */
let TypeOrmHealthIndicator = exports.TypeOrmHealthIndicator = class TypeOrmHealthIndicator extends __1.HealthIndicator {
    /**
    ...
    checkMongoDBConnection(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                driver.mongodb.MongoClient.connect(connection.options.url
                    ? connection.options.url
                    : driver.buildConnectionUrl(connection.options), driver.buildConnectionOptions(connection.options), (err, client) => {
                    if (err)
